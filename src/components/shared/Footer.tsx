          ...
          <Grid cols={4} gap={8}>
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-2 text-sm text-muted-foreground">
                <li><Link href="#" className="hover:text-primary transition-colors">{t("it_jobs")}</Link></li>
                <li><Link href="#" className="hover:text-primary transition-colors">{t("marketing_jobs")}</Link></li>
                <li><Link href="#" className="hover:text-primary transition-colors">{t("design_jobs")}</Link></li>
                <li><Link href="#" className="hover:text-primary transition-colors">{t("sales_jobs")}</Link></li>
              </ul>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-sm text-muted-foreground">{t("newsletter_desc")}</p>
        ...
        <Container>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-muted-foreground">
            ...
            <div className="flex gap-4">
              <Link href="#" className="hover:text-primary transition-colors">{tCommon("language_vi")}</Link>
              <Link href="#" className="hover:text-primary transition-colors">{tCommon("language_en")}</Link>
            </div>
          </div>
        </Container>
      </div>
